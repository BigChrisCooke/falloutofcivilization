...
describe("game flow", () => {
  ...
  it("creates a save, tracks exploration, switches screens, and enters a location after travel", async () => {
    ...
    expect(Object.keys(vaultMoveResponse.body.replay).sort()).toEqual(["companionHelpAvailable", "companionStep", "finalPatch", "steps"]);
    ...
    expect(Object.keys(tavernMoveResponse.body.replay).sort()).toEqual(["companionHelpAvailable", "companionStep", "finalPatch", "steps"]);
