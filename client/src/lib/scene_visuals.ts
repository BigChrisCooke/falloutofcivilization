...
export const INTERIOR_TILE_VISUALS: Record<string, TileVisual> = {
  ...
  bar: { topColor: 0x6b4226, leftColor: 0x4a2e1a, rightColor: 0x362010, edgeColor: 0xc49870, fogTint: 0x171312 },
...
export const INTERIOR_SURFACE_VISUALS: Record<string, HexTerrainVisual> = {
  ...
  bar: { fillColor: 0x6b4226, shadeColor: 0x4a2e1a, ridgeColor: 0xc49870, edgeColor: 0x362010, fogTint: 0x171312 },
